Feature: Post Comments
  ...
  Scenario: Add comment on status update
    ...
    And I have one user "example2@example.com" with password "password" and name "john"
    And I am friends with "john"
    And "john" has a status update "I feel good today"
    And I am the profile page of "john"
